    ...
    <div class="container mt-3">
        <div class="row">
            <div class="card shadow mx-auto">
                <div class="card-body">
                    <h4>Hotplate Cooling Room - *needs to reselect product based on most recently submitted record - can do this when getting the records for recent entries</h4>
                    <hr class="mb-2">
                    <form action="{{ route('hotplate.cooling') }}" method="POST">
                        @csrf
                        <div class="row">
